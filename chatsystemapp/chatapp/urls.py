...
urlpatterns = [
    ...
    path('conversations/<int:pk>/', ConversationRetrieveDestroyView.as_view(), name='conversation_detail'),
    ...
    path('feedback/<int:pk>/', FeedbackRetrieveUpdateView.as_view(), name='feedback_detail_update'),
